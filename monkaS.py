...
player_stats['Team'].fillnan('Random',inplace=true)
                ...
                <div class='player-stats'>
                    <div style='font-size:14px; margin-top:0.5px;'>
                        <div style='display: flex; flex-wrap: wrap; gap: 8px;'>
                            ...
                            <div style='font-size:12px;color:black;'><strong>Fouls Commited:</strong> <span style='color:#000000; font-size:17px; font-weight:bold;'>{avg_stats['fouls_commited']:.2f}</span></div>
                            <div style='font-size:12px;color:black;'><strong>Fouls Received:</strong> <span style='color:#000000; font-size:17px; font-weight:bold;'>{avg_stats['fouls_received']:.2f}</span></div>
                            <div style='font-size:12px;color:black;'><strong>Tackles:</strong> <span style='color:#000000; font-size:17px; font-weight:bold;'>{avg_stats['Tackles']:.2f}</span></div>
                            <div style='font-size:12px;color:black;'><strong>Goals:</strong> <span style='color:#000000; font-size:17px; font-weight:bold;'>{avg_stats['Goals']:.2f}</span></div>
                            <div style='font-size:12px;color:black;'><strong>xG:</strong> <span style='color:#000000; font-size:17px; font-weight:bold;'>{avg_stats['xG']:.2f}</span></div>
                            <div style='font-size:12px;color:black;'><strong>Assists:</strong> <span style='color:#000000; font-size:17px; font-weight:bold;'>{avg_stats['Assists']:.2f}</span></div>
                            <div style='font-size:12px;color:black;'><strong>xA:</strong> <span style='color:#000000; font-size:17px; font-weight:bold;'>{avg_stats['xA']:.2f}</span></div>
