...
with TabB:
    ...
    filtered_team_roster['Importance'] = (15*filtered_team_roster.groupby('player_id')['SoT'].transform('mean'))*filtered_team_roster['player_id'].map(player_id_counts) + (3*filtered_team_roster.groupby('player_id')['minutes'].transform('mean'))
